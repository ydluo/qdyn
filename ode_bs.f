C Bulirsch-Stoer ODE solver from Numerical Recipes

      SUBROUTINE bsstep(y,dydx,nv,x,htry,eps,yscal,hdid,hnext,derivs)
      implicit double precision (a-h,o-z)
      INTEGER nv,NMAX,KMAXX,IMAX
      REAL*8 eps,hdid,hnext,htry,dydx(nv),y(nv),yscal(nv),SAFE1,SAFE2,
     *REDMAX,REDMIN,TINY,SCALMX
      real*8 x,xnew
      PARAMETER (NMAX=262144,KMAXX=8,IMAX=KMAXX+1,SAFE1=.25d0,
     *SAFE2=.7d0,REDMAX=1.d-5,REDMIN=.7d0,TINY=1.d-30,SCALMX=.5d0) !SCALMX=.1d0
